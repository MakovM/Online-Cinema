...
Revision ID: cfe692ffd815
Revises: 
Create Date: 2025-10-13 12:56:15.892024
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.Enum("USER", "MODERATOR", "ADMIN", name="usergroupenum"), nullable=False
        ),
