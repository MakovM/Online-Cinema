...
class EmailSender(EmailSenderInterface):
    ...
    def __init__(
        ...
        purchase_successful_email_template_name: str,
    ):
        ...
        self._purchase_successful_email_template_name = purchase_successful_email_template_name
    ...
    async def send_purchase_successful_email(self, email: str) -> None:
        template = self._env.get_template(self._purchase_successful_email_template_name)
